...
use Gridito\Grid;
use KladnoMinule\Form\PageForm;

class PagesPresenter extends \Neuron\Presenter\AdminModule\AdminPresenter
{
	...
	protected function createComponentGrid($name)
	{
		...
		$grid->addColumn("allowed", "Zobrazit")->setSortable(true);
